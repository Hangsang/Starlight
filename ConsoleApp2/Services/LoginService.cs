...
namespace Server.Services
{
    public class LoginService
    {
        ...
        {
            await session.SendAsync(Opcode.GetBagScRsp, new GetBagScRsp());
        }
        ...
        {
            await session.SendAsync(Opcode.GetPlayerBoardDataScRsp, new GetPlayerBoardDataScRsp());
        }
        ...
        public static async Task OnGetCurSceneInfo(Session session, byte[] _)
        {
            ...
            s.SceneInfo.FloorID = 10001001;
            s.SceneInfo.CurrWorldID = 101;
            s.SceneInfo.CurMapEntryID = 1000001;
            s.SceneInfo.PlaneID = 10001;
            s.SceneInfo.JHNMDMEHBII = 1048579;
            s.SceneInfo.CPADEJILABD.Add(40);
            s.SceneInfo.CPADEJILABD.Add(88);
            s.SceneInfo.CPADEJILABD.Add(14);
            s.SceneInfo.CPADEJILABD.Add(52);
            s.SceneInfo.CPADEJILABD.Add(12);
            s.SceneInfo.OMGOOLPICCA.Add(6);
        ...
        {
            var a = PlayerHeartBeatCsReq.Parser.ParseFrom(payload);
            if (a == null) return;
            var b = new PlayerHeartBeatScRsp();
            b.HeartBeat = a.HeartBeat;
            await session.SendAsync(Opcode.PlayerHeartbeatScReq, b);
        }
