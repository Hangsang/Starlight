...
namespace Starlight.HttpServer.Controllers
{
    internal class AccountController
    {
        internal static void AddHandlers(WebApplication app)
        {
            ...
            app.Map("/hkrpg_global/mdk/agreement/api/getAgreementInfos", (ctx) =>
            {
                return ctx.Response.WriteAsJsonAsync(new { retcode = 0, message = "OK", data = new { marketing_agreements = Array.Empty<object>() } });
            });

            app.Map("/hkrpg_global/combo/granter/api/compareProtocolVersion", (ctx) =>
            {
            ...
            app.Map("/hkrpg_global/combo/granter/api/getConfig", (ctx) =>
            {
                return ctx.Response.WriteAsJsonAsync(new
                {
                    retcode = 0,
            ...
            app.Map("/hkrpg_global/mdk/shield/api/loadConfig", (ctx) =>
            {
                return ctx.Response.WriteAsJsonAsync(new
                {
                    retcode = 0,
