...
namespace Starlight.HttpServer.Models
{
    internal partial class RiskyCheck
    {
        ...
        internal partial class DataScheme
        {
            [JsonProperty("id")]
    ...
    internal partial class GranterLoginBody
    {
        ...
        internal partial class GranterLoginBodyData
        {
            [JsonProperty("uid")]
    ...
    internal partial class ShieldVerifyBody
    {
        [JsonProperty("token")]
        public string Token { get; set; }
    ...
    internal partial class ShieldLoginBody
    {
    ...
    internal partial class ShieldLoginResponse
    {
        [JsonProperty("data")]
        ...
        internal partial class ShieldLoginResponseData
        {
            [JsonProperty("account")]
            ...
            internal partial class ShieldLoginResponseDataAccount
            {
